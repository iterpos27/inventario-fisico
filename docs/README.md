...
2. Crear la base de datos importando `database/database.sql` desde phpMyAdmin o MySQL Workbench.
...
```text
http://localhost/centro_ruliman_inventario/public
```
...
Subir los archivos al hosting, importar `database/database.sql`, ajustar `config/database.php` con los datos de la base de datos del hosting y ejecutar Composer si el proveedor lo permite.
