    ...
    <section class="content-panel">
        <div class="table-responsive">
            <table class="table align-middle">
                <thead><tr><th>Conteo</th><th>Responsable</th><th>Lineas</th><th>Inicio</th><th></th></tr></thead>
                <tbody>
                    <?php foreach ($conteos as $conteo): ?>
                        <tr>
                            ...
                            <td>
                                <?php if (current_user_role() !== 'admin'): ?>
                                    <a class="btn btn-sm btn-primary" href="<?= BASE_URL ?>/conteo.php?id=<?= (int) $conteo['id'] ?>"><?= (int) $conteo['lineas'] > 0 ? 'Continuar' : 'Empezar' ?></a>
                                <?php else: ?>
